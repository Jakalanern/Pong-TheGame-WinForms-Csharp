    ...
    public partial class Form1 : Form
    {
        ...
        private void timerTick(object sender, EventArgs e)
        {
            ...
            if (score <5)
            {
                ...
                {
                    //then
                    //change the speed direction so it moves back up or back
                    speed = -speed;
                }
            }
            else
            ...
            //check the score
            // if the ball has gone past the player through the left
            if (ball.Left < 0)
            {
                //then
                ball.Left = 434; // reset the vall to the middle of the screen
